...
void publishControllerInput(const eer_interfaces::msg::PilotInput& input, const rclcpp::Publisher<eer_interfaces::msg::PilotInput>::SharedPtr& controller_input_publisher) {
...
void launchGUI(const rclcpp::Publisher<eer_interfaces::msg::PilotInput>::SharedPtr& controller_input_publisher, bool launch_controller){
    ...
    //initialize input
    eer_interfaces::msg::PilotInput input;
