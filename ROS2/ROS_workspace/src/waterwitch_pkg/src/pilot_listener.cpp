...
private:
  ...
  waterwitch_pkg::msg::WaterwitchThrustValues current_thrust;
  ...
  { 
    ...
    auto compute_thrust_value = [this](int thruster_index, const eer_messages::msg::PilotInput* pilot_input, std::array<float, 6>& target_thrust_values) 
    {
